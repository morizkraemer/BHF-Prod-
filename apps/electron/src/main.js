...
function createWindow() {
  mainWindow = new BrowserWindow({
    ...
    webPreferences: {
      // MAIN_WINDOW_PRELOAD_WEBPACK_ENTRY is automatically provided by Forge webpack plugin
  ...
  // Load the app - MAIN_WINDOW_WEBPACK_ENTRY is automatically provided by Forge webpack plugin
